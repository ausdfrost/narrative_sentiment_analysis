...
output_file_name = '/jack_ideology_sentiment.csv'
output_file = output_dir + output_file_name
os.system('touch %s'%(output_file))
with open(output_file, 'w', newline='') as file:
    writer = csv.writer(file)
    field = ['sub_id', 'text', 'selected_text', 'raised_religious', 'raised_as', 'currently_religious', 'current_religion', 'current_spirituality', 'most_important_value', 'ultimate_unknown', 'other_values']
    ...
    for dir in sub_dirs:
        ...
        for file in sub_files:
            ...
            for sentence in sentences:
                selected_text = ''
                s = ''
                row = [sub_id, sentence, selected_text, s, s, s, s, s, s, s, s]
                writer.writerow(row)
